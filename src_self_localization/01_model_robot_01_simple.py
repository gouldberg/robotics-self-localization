...
# ----------
# robot
robot1 = IdealRobot(pose=np.array([2, 3, math.pi / 6]).T, sensor=IdealCamera(m), agent=straight)
robot2 = IdealRobot(pose=np.array([-2, -1, math.pi / 5 * 6]).T, sensor=IdealCamera(m), agent=circling, color="red")
